  ...
  render() {
    return (
      <div className='container border'>
        ...
        <NvvFuncComp />
        <hr/>
        <NvvFuncComp fullName="Vu Nguyen" address="FitNTU" email="vanvu@gmail.com"></NvvFuncComp>

        <NvvClassComp />
        <NvvClassComp name="Vu Vu" age="21" phone = "0978611889" email="vanvu@gmaill.com"></NvvClassComp>
